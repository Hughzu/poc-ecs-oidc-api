# ============================================================================
# DATA SOURCES AND LOOKUP RESOURCES
# ============================================================================
...
# ECS Cluster - The main orchestration platform
...
# Application Load Balancer - Main entry point from internet
...
# ALB Target Group - Defines where ALB sends traffic
...
# ALB Listener - Defines how ALB handles incoming requests
...
# ECS Capacity Provider - Links ECS cluster to Auto Scaling Group
